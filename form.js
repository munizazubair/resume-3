document.addEventListener("DOMContentLoaded", function () {
    ...
    generateButton.addEventListener("click", function () {
        ...
        resumeDiv.innerHTML = "\n      <h2>Resume</h2>\n      <h3>Objective</h3><p>".concat(obj, "</p>\n      <h3>Personal Information</h3>\n      <p>Name: ").concat(name, "</p>\n      <p>Nationality: ").concat(nationality, "</p>\n      <p>Gmail: ").concat(gmail, "</p>\n      <p>Contact No: ").concat(contact, "</p>\n      <p>LinkedIn Profile: <a href=\"").concat(linkedin, "\" target=\"_blank\">").concat(linkedin, "</a></p>\n      <h3>Education</h3><p>").concat(education, "</p>\n      <h3>Skills</h3><p>").concat(skills, "</p>\n\n    ");
    });
});
